...
*/
const animalNames = []
zooAnimals.map(animal => animalNames.push(`Name: ${animal.animal_name}, Scientific: ${animal.scientific_name}.`));
...
console.log(populationTotal); // 56 and the arithmetic checks out.
